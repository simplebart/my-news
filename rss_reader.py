...
.aurora-tab {{
  flex:1; text-align:center; padding:.28rem .1rem; border-radius:999px;
  border:1px solid transparent; font-size:.63rem; font-weight:800;
  letter-spacing:.04em; color:rgba(200,200,220,.5); text-decoration:none;
  transition:all .15s;
}}
.aurora-tab.active {{
